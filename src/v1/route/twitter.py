...
from src.v1.route.dependencies import get_user_service, get_bookmark_service, get_current_user
...
async def get_bookmarks(
    ...
    current_user:User = Depends(get_current_user), bookmark_service:BookmarkService = Depends(get_bookmark_service),
    db: AsyncSession = Depends(get_session)
    ):
